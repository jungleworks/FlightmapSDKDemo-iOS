//
//  TrackingModesViewController.swift
//  FlightMap-Demo-iOS
//
...
import UIKit
import Mapbox
class TrackingModesViewController: UIViewController, MGLMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        mapView = MGLMapView(frame: view.bounds, styleURL: FLIGHTMAP.lightTheme)
